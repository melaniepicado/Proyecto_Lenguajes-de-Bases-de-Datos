...
$resultado = VerDatosCliente($_GET["datosCliente"]);
?>
                        ...
                        <div class="col-lg-8">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Actualizar Datos Usuario</h1>
                                </div>

                                <form action="" method="post" class="user">
                                    <input type="hidden" id="idCliente" name="idCliente" value="<?php echo $resultado["idCliente"] ?>">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="number" class="form-control " id="identificacion" name="identificacion" placeholder="Identificación" disabled value="<?php echo $resultado["identificacion"] ?>">
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control " id="segundoApellido" name="segundoApellido" placeholder="Segundo Apellido" value="<?php echo $resultado["SegundApellido"] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control " id="otrasSenales" name="otrasSenales" placeholder="Otras señas" value="<?php echo $resultado["Otras_senas"] ?>">
                                    </div>
                                    <br />
                                    <input type="submit" class="btn btn-primary btn-user btn-block" value="Actualizar" id="btnActualizarCliente" name="btnActualizarCliente">
                                </form>
                            </div>
                        </div>
