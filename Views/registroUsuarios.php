                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form action="" method="post" class="user">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="confirmarContrasenna" name="confirmarContrasenna" required
                                                placeholder="Confirmar Contraseña" onkeyup="HabilitarBoton();">
                                        </div>
                                        <input type="submit" class="btn btn-primary btn-user btn-block" value="Registrarse" disabled
                                        id="btnRegistrarCuenta" name="btnRegistrarCuenta">
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="recuperarUsuario.php">Olvidaste tu cuenta!</a>
                                    </div>
                                    <div class="text-center">
