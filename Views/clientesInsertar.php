                        ...
                        <div class="col-lg-8">
                            <div class="">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Agregar Usuario Nuevo</h1>
                                </div>
                                <form action="" method="post" class="user">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="number" class="form-control " id="identificacion" name="identificacion" minlength="9" maxlenght="9" placeholder="Identificación" value="">
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <br />
                                    <input type="submit" class="btn btn-primary btn-user btn-block" value="Insertar" id="btnInsertarCliente" name="btnInsertarCliente">
                                </form>
                            </div>
                        </div>
                    </div>
